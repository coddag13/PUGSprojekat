...
function ShareTokenCard({ token, sharedUrl, onDelete, isDeleting, onCopy }) {
  ...
  return (
    <article className="route-card rounded-[2rem] p-5">
      <div className="grid gap-5 lg:grid-cols-[1fr_148px] lg:items-start">
        <div>
          ...
          <p className="mt-4 break-all rounded-[1.5rem] border border-white/50 bg-white/70 px-4 py-3 text-sm leading-6 text-slate-700">
            {sharedUrl}
          </p>
        ...
        <div className="flex justify-center">
          <div className="rounded-[1.6rem] border border-slate-200 bg-white p-4 shadow-md">
